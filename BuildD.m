...
% Build Matrix D^{-1} the diagonal matrix of binomial coefficients. Used in
% the Sylvester Subresultant matrices D_{k}^{-1}T_{k}(f,g)
% \frac{1}{\binom{m+n-k}{i}}. 
% D^{-1} \in \mathbb{R}^{(m+n-k+1)\times(m+n-k+1)}
