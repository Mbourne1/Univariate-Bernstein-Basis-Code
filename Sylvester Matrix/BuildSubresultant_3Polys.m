...
% % Inputs
%
% fx : Coefficients of polynomial f(x) in the Bernstein Basis
%
% gx : Coefficients of polynomial g(x) in the Bernstein Basis
%
% hx : Coefficients of polynomial h(x) in the Bernstein Basis
%
% k:  Index of subresultant S_{k} to be built
%
% % Outputs
%
% Sk : The kth Sylvester subresultant matrix S_{k}(f,g,h)
