function [alpha, beta, theta] =  OptimalAlphaBetaTheta(vF_max, vF_min, vG_max, vG_min, vH_max, vH_min)
...
Part1 = [ones(m+1,1)    zeros(m+1,1)    -(0:1:m)'   zeros(m+1,1)     zeros(m+1,1)];
Part2 = [ones(n+1,1)    zeros(n+1,1)    -(0:1:n)'   -ones(n+1,1)     zeros(n+1,1)];
Part3 =  [ones(o+1,1)    zeros(o+1,1)    -(0:1:o)'  zeros(o+1,1)     -ones(o+1,1)];
Part4 = [zeros(m+1,1)   -ones(m+1,1)     (0:1:m)'   zeros(m+1,1)     zeros(m+1,1)];
Part5 = [zeros(n+1,1)   -ones(n+1,1)     (0:1:n)'   ones(n+1,1)      zeros(n+1,1)];
Part6 = [zeros(o+1,1)   -ones(o+1,1)     (0:1:o)'   zeros(o+1,1)     ones(o+1,1)];
